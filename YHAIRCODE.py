...
notebook.add(frame3, text='Suma de nuemros complejos')
...
def sumar_numeros_complejos():
    try:
        # Obtener los números complejos de las entradas
        complejo1 = complex(entry1.get())
        complejo2 = complex(entry2.get())
        ...
        messagebox.showerror("Error", "Por favor, ingrese números complejos válidos.")
# Función para reiniciar las entradas y el resultado
def reiniciar():
    entry1.delete(0, tk.END)  # Limpiar la primera entrada
    entry2.delete(0, tk.END)  # Limpiar la segunda entrada
    etiqueta_resultado.config(text="Resultado: ")  # Reiniciar la etiqueta de resultado

# Crear etiquetas y entradas para los números complejos
tk.Label(frame3, text="Ingrese el primer número complejo (ej. 2+3j):").pack(pady=5)
entry1 = tk.Entry(frame3)
entry1.pack(pady=5)

tk.Label(frame3, text="Ingrese el segundo número complejo (ej. 1+4j):").pack(pady=5)
entry2 = tk.Entry(frame3)
entry2.pack(pady=5)

# Crear un botón para realizar la suma
boton_sumar = tk.Button(frame3, text="Sumar", command=sumar_numeros_complejos)
boton_sumar.pack(pady=20)
boton_reiniciar = tk.Button(frame3, text="Reiniciar", command=reiniciar)
boton_reiniciar.pack(pady=10)
# Etiqueta para mostrar el resultado
etiqueta_resultado = tk.Label(frame3, text="Resultado: ")
...
imagen = Image.open("opti.jpg")  # Cambia "ruta_de_tu_imagen.jpg" por la imagen que quieras usar
